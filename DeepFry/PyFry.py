#Original code from https://github.com/codezoned/PyFry
...
def crushAndBack(img):
    ...
    return img
def addFlare(img, img_path):
    ''' Initialising dlib for frontal facial features '''
    flare = Image.open(f'{dirname}/assets/flare.png')
    detect = dlib.get_frontal_face_detector()
    predict = dlib.shape_predictor(f'{dirname}/assets/shape_predictor_68_face_landmarks.dat')
